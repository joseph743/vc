...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active" data-bind="visible: catsVisible" id="cats"><a href="categories.jsp">Categories</a></li>
...
<div class="page-header">
  ...
  <form action='/someServerSideHandler'>
    <p>You have <span data-bind='text: Categories().length'>&nbsp;</span> Categorie(s)</p>
    <br/>
    <table data-bind='visible: Categories().length > 0' class="table">
        <thead>
            <tr>
                <th>Category ID</th>
                <th>Name</th>
        ...
        <tbody data-bind='foreach: Categories'>
            <tr>
                ...
                <td><input class='required number' data-bind='value: reference, uniqueName: true' /></td>
                <td>&nbsp;&nbsp;&nbsp;<a href='#' data-bind='click: $root.removeCat'>Delete</a></td>
            </tr>
        </tbody>
    </table>
    <br/>
    <a class="flat-butt" data-bind='click: sortByName'>Sort By Name</a>
    <a class="flat-butt" data-bind='click: addCat'>Add Category</a>
    <a class="flat-butt" data-bind='enable: Categories().length > 0' type='submit'>Submit</a>
</form>
</div>	
</body>
