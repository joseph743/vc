...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li  class="active" data-bind="visible: brandsVisible" id="brands"><a href="brands.jsp">Brands</a></li>
...
<div class="page-header">
  ...
  <form action='/someServerSideHandler'>
    <p>You have <span data-bind='text: Brands().length'>&nbsp;</span> Brand(s)</p>
    <br/>
    <table data-bind='visible: Brands().length > 0' class="table">
        <thead>
            <tr>
                <th>Brand ID</th>
                <th>Name</th>
        ...
        <tbody data-bind='foreach: Brands'>
            <tr>
                ...
                <td>&nbsp;&nbsp;&nbsp;<a href='#' data-bind='click: $root.removeBrand'>Delete</a></td>
            </tr>
        </tbody>
    </table>
    <br/>
    <a class="flat-butt" data-bind='click: sortByName'>Sort By Name</a>
    <a class="flat-butt" data-bind='click: addBrand'>Add Brand</a>
    <a class="flat-butt" data-bind='enable: Brands().length > 0' type='submit'>Submit</a>
</form>
</div>	
</body>
