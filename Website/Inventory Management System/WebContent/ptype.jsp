...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"  data-bind="visible: ptypeVisible" id="ptype"><a href="ptype.jsp">Product Type</a></li>
...
<div class="page-header">
  ...
  <form action='/someServerSideHandler'>
    <p>You have <span data-bind='text: pTypes().length'>&nbsp;</span> Product Type(s)</p>
    <br/>
    <table data-bind='visible: pTypes().length > 0' class="table">
        <thead>
            <tr>
        ...
        <tbody data-bind='foreach: pTypes'>
            <tr>
                ...
                <td>&nbsp;&nbsp;&nbsp;<a href='#' data-bind='click: $root.removePType'>Delete</a></td>
            </tr>
        </tbody>
    </table>
    <br/>
    <a class="flat-butt" data-bind='click: sortByName'>Sort By Name</a>
    <a class="flat-butt" data-bind='click: addPType'>Add Product Type</a>
    <a class="flat-butt" data-bind='enable: pTypes().length > 0' type='submit'>Submit</a>
</form>
</div>	
</body>
 ...
 <script type="text/javascript" src="js/ptype.js"></script>
</html>