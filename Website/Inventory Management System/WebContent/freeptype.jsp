...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active" data-bind="visible: freeptypeVisible" id="freeptype"><a href="freeptype.jsp">Free Product Type</a></li>
...
<div class="page-header">
    <h2>Free Product Types</h2>      
  </div>
  <form action='/someServerSideHandler'>
    <p>You have <span data-bind='text: FreePTypes().length'>&nbsp;</span> Free Product Type(s)</p>
    <br/>
    <br/>
    <table data-bind='visible: FreePTypes().length > 0' class="table">
        <thead>
            <tr>
                <th>ID</th>
                <th>Name</th>
        ...
        <tbody data-bind='foreach: FreePTypes'>
            <tr>
                ...
                <td>&nbsp;&nbsp;&nbsp;<a href='#' data-bind='click: $root.removeFreePType'>Delete</a></td>
            </tr>
        </tbody>
    </table>
    <br/>
    <a class="flat-butt" data-bind='click: sortByName'>Sort By Name</a>
    <a class="flat-butt" data-bind='click: addFreePType'>Add Free Product Type</a>
    <a class="flat-butt" data-bind='enable: FreePTypes().length > 0' type='submit'>Submit</a>
</form>
</div>	
</body>
 ...
 <script type="text/javascript" src="js/freeptypes.js"></script>
</html>