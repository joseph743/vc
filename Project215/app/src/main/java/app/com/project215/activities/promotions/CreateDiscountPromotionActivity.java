...
public class CreateDiscountPromotionActivity extends AppCompatActivity implements View.OnClickListener , Spinner.OnItemSelectedListener{
    ...
    Spinner spBrand;
    String selectedBrandReference = "0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_discount_promotion_create);

        context = CreateDiscountPromotionActivity.this;
                ...
                if (jsonObject.has("products")) {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if (i == 0 || !(jb.getString("Product_type_id").contains("1") || jb.getString("Product_type_id").contains("2") || jb.getString("Product_type_id").contains("3") || jb.getString("Product_type_id").contains("4"))) {
                            ...
                            //     productModel.cost = jb.getString("cost");
                    ...
                    ProductAdapter = new ArrayAdapter<ProductModel>(CreateDiscountPromotionActivity.this, R.layout.spinner_text, arrayListProduct);
...
//                break;
    ...
    public void proceedToNextStep() {
        ...
        try {
            for (int i = 0; i < edit_arrayList_main.size(); i = i + 1) {
                ...
                if (str_product.length() != 0 && str_qty.length() != 0) {
                    ...
                    // productObject.put("cost", ProductAdapter.getItem(spinner_arrayList_main.get(i).getSelectedItemPosition()).getProduct_cost());
            ...
            promotionObject.put("promotion_type", "discount");
            promotionObject.put("discount", edit_discount.getText().toString().trim());
        ...
        if (str_discount.length() == 0) {
            ...
            startActivityForResult(new Intent(context, CreateProductActivity.class).putExtra("promotion", promotionObject.toString()), 1);
        }
    ...
    public void fillbrand() {
        try {
            ...
            if (jsonObject.has("brand")) {
                ...
                brandAdapter = new ArrayAdapter<BrandModel>(CreateDiscountPromotionActivity.this, R.layout.spinner_text, arrayListBrand);
